...
const char* default_TOPICO_PUBLISH_2 = "/TEF/device007/attrs/t"; // Tópico MQTT de envio de informações para Broker
const char* default_TOPICO_PUBLISH_3 = "/TEF/device007/attrs/h"; 
const char* default_TOPICO_PUBLISH_4 = "/TEF/device007/attrs/l"; 
const char* default_ID_MQTT = "device007"; // ID MQTT
